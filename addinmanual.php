...
<body id="addinmanual" onclick="clickDocument()">
    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="sectionmanual">
                ...
                <a name="download" class="name">
                    <h2>Download</h2>
                </a>
                <p>Download the 90 day free trial version of the Bond Add In for Word by clicking the button below.</p>
                <a class="manualdownloadaddin" href="bondui-v270-setup.msi"></a>





                <a name="install" class="name">
                ...
                <img src="assets/images/manual1.gif" width=1336 height=277 alt="The Ribbon is hidden in 'Tabs only mode' initially.">
                ...
                <img src="assets/images/manual2.gif" width=1336 height=272 alt="Click on down arrow. Click on 'Always show Ribbon'.">
                ...
                <img src="assets/images/manual3.gif" width=462 height=375 alt="Drop down menu.">



                <a name="dialogue" class="name">
                    <h2>Dialogue boxes</h2>
                </a>

                <p>Press the function key of the command you want to use.</p>
                <img src="assets/images/DialogueBox1.gif" width=1273 height=520 alt="Dialogue Box.">
                <p>Multi toggle buttons - press the function key repeatedly until you have selected the option you want.</p>
                <img src="assets/images/multitoggle.gif" width=240 height=232 alt="Multi toggle button.">
                ...
                <img src="assets/images/DialogueBox2.gif" width=1144 height=744 alt="Dialogue Box.">




                <a name="qcb" class="name">
...
<img src="assets/images/SelectQCB.gif" width=1336 height=1050 alt="Select Quick Command Bars.">
<p>Hold down the function key of the QCB you want to edit. The 'Edit Custom Quick Command Bar' window will open.</p>
<img src="assets/images/EditCustom.gif" width=1336 height=300 alt="Dialogue Box.">
<p></p>
                ...
                <p>Designed for desktop computers with mouse and keyboard, and multiple monitors, Desktop Mode has a grid of four rows of tiles, mapped to the first four rows of your keyboard. This allows you to access forty programs or files from any program with just two keypresses. The bottom row (ZXCVBNM) is used for Quick Snap layouts, and 'Move between monitors' commands.
                    ...
                    When you first use Program Picker, the Launcher Mode tiles will be empty. Press the Spacebar to change to Normal Mode. Here you will see all the currently running programs on your PC. From this screen you can select programs to pin to tiles on the Launcher Mode page. </p>

                <a name="disable" class="name">
